      ...
      <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12">
              ...
              <div class="mt-2">
                <div
                  ...
                  <input
                    ...
                    placeholder="Paralegal" value="{{ $job->title }}" required>
                </div>
                @error('title')
          ...
          <div class="flex justify-between items-center">
            <button class="text-sm text-red-500 leading-6 font-semibold border border-1 border-red-500 px-3 py-2 rounded-md" form="delete-form">
                Delete
            </button>
